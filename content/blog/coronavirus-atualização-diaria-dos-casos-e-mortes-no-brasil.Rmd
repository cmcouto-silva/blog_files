...
library(reticulate)
invisible(Sys.setlocale(category = "LC_TIME", locale = "pt_BR.UTF-8"))
...
Post atualizado pela última vez em: ``` `r format(Sys.time(), "%d de %B de %Y, %H:%M")`h (Horário de Brasília - UTC-3))```.
